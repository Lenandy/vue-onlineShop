...
<template>
  <!-- 导航栏容器，使用Flex布局确保元素水平居中并垂直对齐 -->
  <div class="flex justify-between items-center">
    <!-- 主页链接，使用SVG图标增强视觉效果 -->
    <RouterLink class="text-3xl" to="/shop">
